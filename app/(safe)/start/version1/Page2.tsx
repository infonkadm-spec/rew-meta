...
export default function Page2({
  ...
  useEffect(() => {
    if (playerRef.current && !playerRef.current.querySelector('vturb-smartplayer')) {
      ...
      el.id = 'vid-68ff65eecf9c7bc428d97d22';
    ...
    <>
      ...
      <div className="flex flex-col gap-4 text-sm appear">
        ...
        <div className="w-full rounded-3xl overflow-hidden">
          ...
          <Script id="vturb-vid-68ff65eecf9c7bc428d97d22" strategy="afterInteractive">
            {`
              var s=document.createElement("script");
              s.src="https://scripts.converteai.net/9e5adb60-2a6e-4137-97bb-0eaa0f5632d0/players/68ff65eecf9c7bc428d97d22/v4/player.js";
              s.async=!0;
        ...
        <div className="flex flex-col gap-2">
          <h2 className="text-lg font-semibold">Burgerville Big Sassy Cheeseburger</h2>
          ...
          <div className="flex items-center justify-between py-2">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="font-bold text-gray-900">Burgerville</span>
            </div>
