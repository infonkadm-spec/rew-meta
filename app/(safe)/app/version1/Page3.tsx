...
export default function Page3({
  ...
  useEffect(() => {
    if (playerRef.current && !playerRef.current.querySelector('vturb-smartplayer')) {
      ...
      el.id = 'vid-68ff65ea5a5e3dd3ccc372cd';
    ...
    <>
      ...
      <div className="flex flex-col gap-4 text-sm appear">
        ...
        <div className="w-full rounded-3xl overflow-hidden">
          ...
          <Script id="vturb-vid-68ff65ea5a5e3dd3ccc372cd" strategy="afterInteractive">
            {`
              var s=document.createElement("script");
              s.src="https://scripts.converteai.net/9e5adb60-2a6e-4137-97bb-0eaa0f5632d0/players/68ff65ea5a5e3dd3ccc372cd/v4/player.js";
              s.async=!0;
        ...
        <div className="flex flex-col gap-2">
          <h2 className="text-lg font-semibold">Always Ultra Thin - Fear No Gush</h2>
          <p className="text-sm text-gray-600">1.1M views - 18 days ago</p>
          ...
          <div className="flex items-center justify-between py-2">
            <div className="flex items-center gap-3">
              <Image
                width="40"
                height="40"
                src="/logos/step-2.jpg"
                alt="Always"
                className="rounded-full"
              />
              <span className="font-bold text-gray-900">Always</span>
            </div>
